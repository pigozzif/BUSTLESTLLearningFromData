...
//    private int num = 1;
    ...
    public I80FitnessFunction() throws IOException {
        ...
        this.signals = signalBuilder.parseSignals("./data/Next_Generation_Simulation__NGSIM__Vehicle_Trajectories_and_Supporting_Data9.csv", boolIndexes, doubleIndexes);
