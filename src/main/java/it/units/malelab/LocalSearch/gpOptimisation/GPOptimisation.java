...
import it.units.malelab.LocalSearch.gaussianProcesses.GpDataset;
import it.units.malelab.LocalSearch.gaussianProcesses.GpPosterior;
import it.units.malelab.LocalSearch.gaussianProcesses.HyperparamLogLikelihood;
import it.units.malelab.LocalSearch.gaussianProcesses.kernels.KernelFunction;
import it.units.malelab.LocalSearch.gaussianProcesses.regression.RegressionGP;
import it.units.malelab.LocalSearch.gpOptimisation.tranformations.EmptyTransformer;
import it.units.malelab.LocalSearch.gpOptimisation.tranformations.LogTransformer;
import it.units.malelab.LocalSearch.gpOptimisation.tranformations.Transformer;
import it.units.malelab.LocalSearch.numeric.algebra.IAlgebra;
import it.units.malelab.LocalSearch.numeric.algebra.JblasAlgebra;
import it.units.malelab.LocalSearch.numeric.algebra.NonPosDefMatrixException;
import it.units.malelab.LocalSearch.numeric.optimization.LocalOptimisation;
import it.units.malelab.LocalSearch.numeric.optimization.ObjectiveFunction;
import it.units.malelab.LocalSearch.numeric.optimization.PointValue;
import it.units.malelab.LocalSearch.numeric.optimization.methods.PowellMethodApache;
